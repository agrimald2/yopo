<template>
  <div id="card-product">
    ...
    <div class="row sub-y">
      <div
        class="product_card row"
        style="width:100%;height:100%"
      >
        <div
          class="col-4"
          style="padding-left: 0px;padding-right: 5px; justify-content: center; align-items: center; display: flex;"
        >
          <div class="product_info">
            ...
            <div
              class="row product_actions"
              style="text-align: center; display: flex; align-items: center; margin-top:5px"
            >
              <div
                class="col-4 pa_counter"
                style="color: black; font-family: EATHOMASANS; font-size:0.85rem"
              >
              ...
              <button
                @click="minusP(localProduct); $forceUpdate()"
                class="col-3 btn_maths"
                style="color: #ddc237;"
              >
                <span>
              ...
              <button
                @click="plusP(localProduct); $forceUpdate()"
                class="col-3 btn_maths"
              >
                <span>
                  <i
              ...
              <div
                class="btn btn_add"
                @click="addP(localProduct); $forceUpdate()"
                style="width:100%"
              >
                agregar
              </div>
