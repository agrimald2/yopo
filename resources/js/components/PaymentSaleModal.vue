...
export default {
  ...
  methods: {
    submit() {
      $('.modal').modal('hide');
      this.localSale.payment_date = moment().startOf('day');        
      this.localSale.payment_time = moment().format('HH:mm:ss');
      this.localSale.payment_autor = '';  
      this.localSale.payment_id = 1    
