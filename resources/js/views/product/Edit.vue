<template>
  <div>
    ...
    >
              ...
              <div class="col">
                ...
                >
                  <option
                    ...
                    disabled
                    selected
                  >SELECCIONE UNA SUB CATEGORIA</option>
                  <option
            ...
            <div class="row form-group">
              <div class="col">
                ...
                <input
                  ...
                  step="any"
                  class="form-control"
                  placeholder="Precio de Venta (Incluir IGV)"
                  required
                >
              </div>
            </div>
      ...
      <div class="col">
        <div class="card">
          ...
          <label
            for="inputFile"
            class="card-body text-white text-center border"
    ...
    <div class="mt-6 px-3 sm:px-4 bg-white rounded pt-3 pb-5 mx-4">
      <product-aditionals :id="$route.params.productId" />
    </div>
  </div>
</template>
