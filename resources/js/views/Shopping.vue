<template>
  <div>
    ...
    <div
      ...
      style="background-color: #ddc237; min-height:100vh"
    >
        ...
        <div class="row container_list">
          ...
          >
            <div class="row">
              <div class="col-7">
                <img
                  :src="`/api/products/${item.image_url}`"
                  :alt="item.name"
                >
                &nbsp;
                {{ item.name }}
      ...
      <div class="bot_cart">
        ...
        <div class="row sale_info">
          <div class="row">
            ...
            >S/ &nbsp {{ totalProducts.toFixed(2) }} </div>
          </div>
        </div>
    ...
    >
      <table
        class='table'
        style="background-color: white; margin-top: 5vh;"
      >
        ...
        <tbody>
          ...
          >
            ...
            <td>
              <span
                class="text-success"
                v-if="checkInventory(item).length"
              >{{ checkInventory(item).map(e => e.weight).reduce((a, b) => a + b, 0).toFixed(3) }} {{ item.short_unit }}</span>
              <span
                class="text-danger"
                v-else
              >No Disponible</span>
      ...
      <div class="row">
        <div class="col d-flex justify-content-end">
          <router-link
            to="/store"
            class="btn my-3 cart_buttons mr-2"
          ...
          <button
            type="button"
            class="btn btn-dark my-3 cart_buttons"
            @click="checkDelivery"
          >
            <feather type='check' />
            Pagar ahora
