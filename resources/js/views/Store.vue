<template>
  <div>
    ...
    <div class="row d-sm-block d-md-none">
      <nav
        class="navbar navbar-expand-md navbar-light shadow-sm fixed-top store_topbar"
        style="color:black;"
      >
        ...
        <span v-else>
          <a href="https://wa.me/51924649794?text=Hola,%20¿a%20que%20hora%20abriran?"><span style="color:black"> Tienda Cerrada </span> <i
              class="fab fa-whatsapp"
              style="font-size: 1.6rem; color: black;"
            ></i></a>
        </span>
        <router-link
          v-if="offices[0].disabled == 1"
          to="/shopping"
        ...
        >
          ...
          {{ saleProducts.length }}
          <img
            src="@/assets/img/yellow_circle.png"
            alt=""
          >
        </router-link>
        <router-link
          ...
          to=""
          class="d-flex align-items-center"
          style="color: red; font-size: 0.8rem; position:fixed; right:20vw"
        >
          <!--<feather class="feather-lg mr-2" type="shopping-cart"/>-->
          :(
          <img
        ...
        <div class="category_selector row">
          <div class="category_container">
            ...
            >
              <a
                v-if="item.name==='FROZEN'"
                class="nav-link"
                href="#"
                @click.prevent="category_id = item.id; page = 0"
                style="color:#5895D3"
              >
                <span
      ...
      <a
        href="#"
        @click.prevent="category_id = null; page = 0"
      >
        <img
          src="@/assets/img/comeyopo.png"
          alt="COME YOPO"
          style="width: 100vw; position:fixed; bottom:0; z-index: 2;"
        >
      </a>
    ...
    <div class="row d-none d-md-block">
      ...
      <div
        class="container row"
        style="padding-top:22vh;padding-bottom:5vh; justify-content:center"
      >
        <div
    ...
    filterProducts() {
      return this.products
        ...
        .filter(
          e =>
            !this.key ||
            e.name.toLowerCase().includes((this.key || "").toLowerCase())
        )
        .splice(
